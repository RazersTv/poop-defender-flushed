...
public class flushedmain {
	public static void main(String[] args) {
		...
		ImageIcon icon = new ImageIcon(
				"C:\\Connolly AP Comp Sci\\Poop-Defender\\Development Repo\\poop-defender-flushed-main\\poop-defender-flushed-main\\poop-defender_flushed\\assets\\lobby-background.png");
		/*
		...
		frame.addKeyListener(new MovingForward());
		// makes it visible
		// frame.setVisible(true);
		...
		goal.setBounds(400, 400, 600, 600);
		goal.setSize(300, 300);
		 ...
		 * try{
		 * filePath =
		 * "Please input your filepath for the \"assets\" folder. You will only need to do this one time."
		 * ;
...
class MovingForward extends KeyAdapter {
